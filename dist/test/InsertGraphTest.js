...
describe('Insert tests', function () {
    ...
    describe('#serialize', function () {
        ...
        it('should correctly serialize an Project with a single Model', function (done) {
            var guid = Common.Guid.newGuid();
        ...
        it('should correctly serialize an Project with a single Model and an attached Node', function (done) {
        ...
        it('should correctly serialize an Project with a single Model, Node with connector', function (done) {
            var guids = {};
        ...
        it('should correctly serialize an Project with a single Model, 2 Nodes with connector with an edge', function (done) {
            var guids = {};
            guids.model = uniqueGUID();
            guids.node = uniqueGUID();
        ...
        it('should correctly serialize a changed Property on a single Model', function (done) {
            var guid = Common.Guid.newGuid();
            var guidstr = guid.toString();
            subject.addModel(guid, "TEST_MODEL");
            var result = subject.serialize();
